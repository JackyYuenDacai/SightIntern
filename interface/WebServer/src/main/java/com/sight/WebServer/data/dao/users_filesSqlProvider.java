...
import com.sight.WebServer.data.model.users_filesExample.Criteria;
import com.sight.WebServer.data.model.users_filesExample.Criterion;
...
public class users_filesSqlProvider {
    ...
    public String countByExample(users_filesExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("users_files");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(users_filesExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("users_files");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String selectByExample(users_filesExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        users_files record = (users_files) parameter.get("record");
        users_filesExample example = (users_filesExample) parameter.get("example");
    ...
    protected void applyWhere(SQL sql, users_filesExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
